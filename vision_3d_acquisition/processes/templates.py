    ...
    return ProcessTemplate(
        ...
        default_parameters={
            ...
            "ellipse_fitting": {
                "enabled": True,
                "min_fit_points": 8,
                "fit_method": "opencv_fitEllipse",
                "refinement_method": "none",
                "refinement_max_iterations": 50,
                "refinement_convergence_epsilon": 1e-3,
                "refinement_robust_loss": "huber",
                "refinement_outlier_weight": 0.25,
                "refinement_edge_distance_weight": 1.0,
                "min_contour_points": 8,
                "contour_simplification_epsilon": 0.0,
        ...
        steps=[
            ...
            StepDefinition(step_id="morphology", title="Morphology cleanup", namespace="image_2d.segment", default_algorithm_key="image_2d.segment.morphology", output_artifact_types=["cleaned_mask", "overlay_image", "morphology_metrics", "morphology_debug_json", "rejected_components_overlay"], params_schema={"operation": {"type": "string", "enum": ["open_close", "close_open", "open_only", "close_only", "erode", "dilate", "none"]}, "morph_op": {"type": "string", "enum": ["none", "erode", "dilate", "open", "close", "open_close", "erode_dilate"]}, "open_kernel": {"type": "integer", "minimum": 1, "maximum": 31}, "close_kernel": {"type": "integer", "minimum": 1, "maximum": 31}, "iterations": {"type": "integer", "minimum": 1, "maximum": 20}, "erode_kernel_size": {"type": "integer", "minimum": 1, "maximum": 31}, "erode_iterations": {"type": "integer", "minimum": 1, "maximum": 20}, "dilate_kernel_size": {"type": "integer", "minimum": 1, "maximum": 31}, "dilate_iterations": {"type": "integer", "minimum": 1, "maximum": 20}, "close_kernel_size": {"type": "integer", "minimum": 1, "maximum": 31}, "fill_holes": {"type": "boolean"}, "min_area_px": {"type": "integer", "minimum": 0, "maximum": 10000000}, "max_area_px": {"type": "integer", "minimum": 0, "maximum": 100000000}, "cleanup_min_area": {"type": "integer", "minimum": 0, "maximum": 10000000}, "cleanup_max_area": {"type": "integer", "minimum": 0, "maximum": 100000000}, "cleanup_min_width": {"type": "integer", "minimum": 0, "maximum": 100000}, "cleanup_min_height": {"type": "integer", "minimum": 0, "maximum": 100000}, "cleanup_max_aspect_ratio": {"type": "number", "minimum": 0.0, "maximum": 1000.0}, "cleanup_border_reject": {"type": "boolean"}, "cleanup_keep_largest_n": {"type": "integer", "minimum": 0, "maximum": 100000}, "overlay_alpha": {"type": "number", "minimum": 0.05, "maximum": 0.95}, "overlay_color_r": {"type": "integer", "minimum": 0, "maximum": 255}, "overlay_color_g": {"type": "integer", "minimum": 0, "maximum": 255}, "overlay_color_b": {"type": "integer", "minimum": 0, "maximum": 255}}),
            ...
            StepDefinition(step_id="ellipse_fitting", title="Ellipse/circle fitting", namespace="image_2d.measure", default_algorithm_key="image_2d.measure.ellipse_fit", output_artifact_types=["ellipse_overlay", "ellipse_metrics", "ellipse_summary", "ellipse_debug_overlay", "ellipse_fit_artifact"], overlay_types=["ellipse", "polyline", "text"], params_schema={"enabled": {"type": "boolean"}, "fit_method": {"type": "string", "enum": ["opencv_fitEllipse", "opencv_fitEllipseAMS", "opencv_fitEllipseDirect", "ransac_ellipse"]}, "refinement_method": {"type": "string", "enum": ["none", "nonlinear_least_squares", "robust_nonlinear"]}, "refinement_max_iterations": {"type": "integer", "minimum": 1, "maximum": 10000}, "refinement_convergence_epsilon": {"type": "number", "minimum": 0.000001, "maximum": 1.0}, "refinement_robust_loss": {"type": "string", "enum": ["none", "huber", "tukey"]}, "refinement_outlier_weight": {"type": "number", "minimum": 0.0, "maximum": 1.0}, "refinement_edge_distance_weight": {"type": "number", "minimum": 0.0, "maximum": 1000.0}, "min_fit_points": {"type": "integer", "minimum": 5, "maximum": 1000}, "min_contour_points": {"type": "integer", "minimum": 5, "maximum": 10000}, "contour_simplification_epsilon": {"type": "number", "minimum": 0.0, "maximum": 1000.0}, "use_convex_hull": {"type": "boolean"}, "ransac_iterations": {"type": "integer", "minimum": 1, "maximum": 10000}, "ransac_inlier_threshold_px": {"type": "number", "minimum": 0.01, "maximum": 1000.0}, "ransac_min_inlier_ratio": {"type": "number", "minimum": 0.01, "maximum": 1.0}, "ransac_random_seed": {"type": "integer", "minimum": 0, "maximum": 2147483647}, "max_axis_ratio": {"type": "number", "minimum": 1.0, "maximum": 1000.0}, "min_axis_px": {"type": "number", "minimum": 0.0}, "max_axis_px": {"type": "number", "minimum": 0.0}, "max_fit_rmse": {"type": "number", "minimum": 0.0, "maximum": 1000.0}, "max_eccentricity": {"type": "number", "minimum": 0.0, "maximum": 1.0}, "min_fill_ratio": {"type": "number", "minimum": 0.0, "maximum": 2.0}, "reject_border_touching": {"type": "boolean"}, "fit_error_threshold": {"type": "number", "minimum": 0.0, "maximum": 2.0}}),
