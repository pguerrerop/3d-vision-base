...
def main() -> int:
    parser = argparse.ArgumentParser(description="Replay all replay-manifest-backed takes in a dataset session.")
    ...
    settings = _settings()
    payload = ReplayableAcquisitionService(settings.data_dir).replay_session(
