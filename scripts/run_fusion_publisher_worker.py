...
from vision_3d_acquisition.runtime.workers import FusionPublisherWorker  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run fusion + publication runtime worker.")
...
def main() -> int:
    ...
    worker = FusionPublisherWorker(
        settings=settings,
        manager=manager,
        worker_id="fusion_publisher_worker",
